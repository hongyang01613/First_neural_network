...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for x, y in zip(features, targets):
            ...
            hidden_inputs = np.dot(x[:,None].T, self.weights_input_to_hidden) # signals into hidden layer
...
# 
# #### 请将你的答案填写在下方
# 总体预测还可以，偏差不是太大，在小数据区域预测偏差较明显，验证结果误差过大的原因，可以尝试增加训练次数和减小学习效率，但因此会增加学习时间。
